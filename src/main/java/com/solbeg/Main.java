...
public class Main {
    ...
    public BigDecimal getBalanceByEmail(String email) {
        return users.stream().filter(user -> user.getEmail().equals(email)).findFirst().orElseThrow(() -> new EntityNotFoundException("Cannot find User by email=" + email)).getBalance();
    }
